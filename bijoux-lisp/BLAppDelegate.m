...
@property (strong, nonatomic) BLEngine *blengine;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[BLViewController alloc] initWithNibName:@"BLViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[BLViewController alloc] initWithNibName:@"BLViewController_iPad" bundle:nil];
    }
...
-(NSString*) remoteMessageInterface:(RemoteMessageInterface*)interface
    ...
    return [self.blengine eval:message];
}
